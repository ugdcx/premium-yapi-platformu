...
export const leadApplications = [
  {
    ...
    city: "Sakarya",
    district: "Akyazı",
    serviceType: "Tadilat ve Değer Artırma",
  ...
  },
  {
    ...
    city: "İstanbul",
    district: "Zekeriyaköy",
    serviceType: "Anahtar Teslim Yapı",
  ...
  },
  {
    ...
    city: "Yalova",
    district: "Merkez",
    serviceType: "Gurbetçi Ev Takibi",
    description: "Yurt dışından takip edilecek daire tadilatı için fotoğraflı ilerleme isteği.",
...
export const projects = [
  {
    ...
    photos: [
      { id: "photo-1", url: "", caption: "Mutfak söküm işlemi tamamlandı.", uploadedBy: "worker", workItemId: "work-4", stage: "Süreç", createdAt: "2026-05-07T14:30:00.000Z" },
      { id: "photo-2", url: "", caption: "Banyo seramik teslimatı sahaya alındı.", uploadedBy: "worker", workItemId: "work-3", stage: "Malzeme", createdAt: "2026-05-06T16:45:00.000Z" },
      { id: "photo-3", url: "", caption: "Zemin yüzeyi uygulama öncesi kaydedildi.", uploadedBy: "admin", workItemId: "work-1", stage: "Öncesi", createdAt: "2026-05-05T10:20:00.000Z" },
      { id: "photo-4", url: "", caption: "Boya öncesi duvar tamiri başladı.", uploadedBy: "worker", workItemId: "work-2", stage: "Süreç", createdAt: "2026-05-07T09:15:00.000Z" }
    ],
    ...
    notes: [
      ...
      { id: "note-2", visibility: "client", content: "BLAAG ekibi onaylanan gelişmeleri burada paylaşır.", createdAt: now }
    ]
  },
  {
