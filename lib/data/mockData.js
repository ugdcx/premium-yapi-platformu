...
export const leadApplications = [
  {
    ...
    city: "Sakarya",
    district: "Akyazı",
    serviceType: "Konut Yenileme & Tadilat",
    description:
      "Mutfak, banyo, salon ve dış cephe alanlarında değer artışı odaklı renovasyon.",
    budgetRange: "₺1.250.000",
    startTime: "1 ay içinde",
    photos: [
      "mutfak-mevcut-durum.jpg",
      "banyo-seramik-teslimati.jpg",
      "dis-cephe-kesif-notu.pdf"
    ],
    status: "İnceleniyor",
    createdAt: "2026-04-25T09:30:00.000Z",
    updatedAt: now,
    adminNotes:
      "Mutfak ve banyo öncelikli. Dış cephe keşfine göre metraj netleşecek."
  },
  {
    id: "lead-2",
    fullName: "Deniz Arman",
    ...
    description:
      "Arsa üzerinde yeni villa yapımı için ilk kapsam değerlendirmesi.",
    budgetRange: "₺9.000.000 - ₺12.000.000",
    startTime: "3 ay içinde",
    photos: ["arsa-konumu.pdf", "referans-villa-gorselleri.zip"],
    status: "Yeni",
  ...
  },
  {
    ...
    city: "Muğla",
    district: "Bodrum",
    serviceType: "Gayrimenkul Değer Artışı & Danışmanlığı",
    description:
      "Villa satış hazırlığı ve portföy sunumu için değer artışı çalışması.",
    budgetRange: "₺18.000.000 beklenti",
    startTime: "Hemen",
    photos: ["ilan-fotograflari.zip", "ekspertiz-notu.pdf"],
  ...
  },
  {
    ...
    serviceType: "Anahtar Teslim İnşaat",
    description:
      "Müstakil konut için proje planlama, uygulama ve teslim koordinasyonu.",
    budgetRange: "₺7.000.000 - ₺9.000.000",
  ...
  },
  {
    ...
    description:
      "Yurt dışından takip edilecek daire yenilemesi için görünür ilerleme isteği.",
    ...
    adminNotes: "Müşteri uzaktan takip bağlantısı istiyor."
  }
];
    ...
    workItems: [
      {
        ...
        description: "Mevcut zemin sökümü ve yüzey tesviyesi.",
        status: "Tamamlandı",
        plannedDate: "2026-04-26",
        completedDate: "2026-04-27",
        notes: "Yeni kaplama için alan hazırlandı."
      },
      {
        id: "work-2",
        title: "Boya hazırlığı",
        description: "Duvar yüzey tamiri, astar ve boya öncesi kontrol.",
        status: "Uygulamada",
        plannedDate: "2026-05-03",
        notes: "Salon ve koridor yüzeyleri kontrol ediliyor."
      },
      {
        id: "work-3",
        title: "Banyo yenileme",
        description: "Tesisat çıkışları, yalıtım ve seramik uygulaması.",
        status: "Planlandı",
        plannedDate: "2026-05-08",
        notes: "Malzeme teslimi bekleniyor."
      },
      {
        id: "work-4",
        title: "Mutfak yenileme",
        description: "Mutfak söküm, elektrik kontrolü ve dolap hazırlığı.",
        status: "Tamamlandı",
        plannedDate: "2026-04-28",
        completedDate: "2026-05-02",
        notes: "Elektrik kontrolü için alan hazırlandı."
      },
      {
        id: "work-5",
        title: "Dış cephe kontrolü",
        description: "Cephe boya ve yalıtım ön incelemesi.",
        status: "Planlandı",
        plannedDate: "2026-05-12",
        notes: "Hava durumuna göre planlanacak."
      }
    ],
    photos: [
      {
        id: "photo-1",
        url: "",
        caption: "Mutfak söküm işlemi tamamlandı.",
        uploadedBy: "worker",
        workItemId: "work-4",
        stage: "Süreç",
        status: "approved",
      ...
      },
      {
        id: "photo-2",
        url: "",
        caption: "Banyo seramik teslimatı sahaya alındı.",
        uploadedBy: "worker",
        workItemId: "work-3",
        stage: "Malzeme",
        status: "approved",
        visible_to_customer: true,
        createdAt: "2026-05-06T16:45:00.000Z"
      },
      {
        id: "photo-3",
        url: "",
        caption: "Zemin yüzeyi uygulama öncesi kaydedildi.",
        uploadedBy: "admin",
        workItemId: "work-1",
        stage: "Öncesi",
        status: "approved",
      ...
      },
      {
        id: "photo-4",
        url: "",
        caption: "Boya öncesi duvar tamiri başladı.",
        uploadedBy: "worker",
        workItemId: "work-2",
        stage: "Süreç",
    ...
    notes: [
      {
        id: "note-1",
        visibility: "admin",
        content: "Mutfak ve banyo öncelikli takip edilecek.",
        createdAt: now
      },
      {
        id: "note-2",
        visibility: "client",
        content: "BLAGG Studio ekibi onaylanan gelişmeleri burada paylaşır.",
        createdAt: now
      }
    ]
  },
...
export const workers = [
  {
    ...
    normalizedPhone: normalizePhone("0532 001 00 02"),
    specialty: "Genel saha",
    activeProjectId: "project-villa-renovasyon",
    workerToken: "1234567"
  },
  {
    id: "worker-2",
    ...
    normalizedPhone: normalizePhone("0532 444 18 20"),
    specialty: "Tesisat",
    activeProjectId: "project-villa-renovasyon",
    workerToken: "ayhan-123"
  },
  {
    id: "worker-3",
    fullName: "Saha Fotoğraf Ekibi",
    phone: "0532 700 44 11",
    normalizedPhone: normalizePhone("0532 700 44 11"),
    specialty: "Görsel raporlama",
    activeProjectId: "project-villa-satis",
    workerToken: "photo-team"
  }
];

export const activeClientProject = projects.find(
  (project) => project.clientToken === "1234567"
);
export const activeWorkerProject = projects.find(
  (project) => project.workerToken === "1234567"
);
